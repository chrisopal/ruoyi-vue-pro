...
public class ReportEvidenceGatewayImpl implements ReportEvidenceGateway {
    ...
    private static final String LINKED_BIZ_TYPE_LIMS_REPORT = "lims_report";
    ...
    private LabEvidenceLinkSaveReqVO buildEvidenceLink(IssuedReportEvidence evidence, Long evidenceObjectId) {
        ...
        reqVO.setLinkedBizType(LINKED_BIZ_TYPE_LIMS_REPORT);
        reqVO.setLinkedBizId(evidence.reportId());
        reqVO.setLinkedBizNo(evidence.reportNo());
        ...
        reqVO.setRemark("由 LIMS 报告签发自动生成；检测需求：" + evidence.requestNo());
        return reqVO;
    }
